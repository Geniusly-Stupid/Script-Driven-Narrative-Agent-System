...
def main() -> int:
    mock_pages = [
        'Scene opening in the city. DAY 1\nPlot Alpha starts\nAlice investigates the gate.',
        'Chapter shift\nBob and Carol discuss clues at 09:30.\nThey reveal a hidden map.',
        'Night falls in OldTown.\nFight breaks out and group escapes.',
        'Act II\nNew objective appears at dawn.\nFind the relic in ruins.',
    ]
